...
bb:
  ...
  ;store i32 %tmp14, i32* %tmp7, align 4
  %tmp7_0 = add i32 0, %tmp14 
  ;br label %bb16
  ...
  %tmp7_2 = select i1 %tmp10, i32 %tmp7_0, i32 %tmp7_1
  store i32 %tmp7_2, i32* %tmp7, align 4
