 ...
 * Code created using PandA - Version: PandA 0.9.6 - Revision 5e5e306b86383a7d85274d64977a3d71fdcff4fe - Date 2020-05-03T22:22:59
 * /opt/panda/bin/bambu executed with: /opt/panda/bin/bambu --compiler=I386_CLANG6 --simulate ../tmp/example_statements_multiple_named.ll 
 */
...
unsigned int example_statements_multiple(unsigned int Pd5, unsigned int Pd6, unsigned int Pd7, unsigned int Pd8);
...
int main()
{
   ...
   unsigned int return_port;
   {
      ...
      Pd5 = 15;
      fprintf(__bambu_testbench_fp, "//parameter: Pd5 value: 15\n");
      fprintf(__bambu_testbench_fp, "p00000000000000000000000000001111\n");
      Pd6 = 10;
      fprintf(__bambu_testbench_fp, "//parameter: Pd6 value: 10\n");
      fprintf(__bambu_testbench_fp, "p00000000000000000000000000001010\n");
      Pd7 = 3;
      fprintf(__bambu_testbench_fp, "//parameter: Pd7 value: 3\n");
      fprintf(__bambu_testbench_fp, "p00000000000000000000000000000011\n");
      Pd8 = 2;
      fprintf(__bambu_testbench_fp, "//parameter: Pd8 value: 2\n");
      fprintf(__bambu_testbench_fp, "p00000000000000000000000000000010\n");
      // function call
      return_port = example_statements_multiple(Pd5, Pd6, Pd7, Pd8);
