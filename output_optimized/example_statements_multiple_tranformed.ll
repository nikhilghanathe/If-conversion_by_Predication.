...
bb34:
	 %tmp7_merge0 = select i1 %tmp21, i32 %tmp7_t0,i32 %tmp7_f0
store i32 %tmp7_merge0, i32* %tmp7, align 4
 %tmp8_merge = select i1 %tmp21, i32 %tmp8_t0,i32 0
